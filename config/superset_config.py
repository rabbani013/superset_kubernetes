...
# When Superset starts up, it reads this configuration and:
# Replaces the default SecurityManager with our CustomSecurityManager
# All user creation (CLI, UI, API) now goes through our custom methods
# Our add_user method gets called instead of the default one
...
def send_welcome_email_signal(sender, **kwargs):
    ...
    try:
        print("🎯 Flask signal triggered for user creation")
        ...
        if user and hasattr(user, 'email') and user.email:
            ...
            print("❌ No user or email found in signal")
    except Exception as e:
